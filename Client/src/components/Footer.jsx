  ...
  <div className=" footer py-4"style={{textAlign:"center"}}>
    <div className="row">
      ...
      <div className="col-md-4 mb-3">
        ...
        <p >
          <h4 className='pt-4'>Welcome to your <span style={{color:"red"}}>Paradise </span>!</h4> 
      ...
      <div className="col-md-4 mb-3">
       ...
       { user?<><ul className="list-unstyled"  style={{ lineHeight: "30px"}}>
          ...
          <li><a href="/home" class="text-white text-decoration-none">Delhi paradise</a></li>
      ...
      <div class="col-md-4 mb-3" id="contact-details">
        ...
        <p><i class="fa fa-map-marker"></i> MG Road -24, Dehi, India</p>
        <p><i class="fa fa-phone"></i> +9123 456 7890</p>
        <p><i class="fa fa-envelope"></i> info@delhiparadise.com</p>
        <div>
